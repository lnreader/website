...
- **Node.js 20+** (use [`nvm`](https://github.com/nvm-sh/nvm) if you juggle versions)
- **pnpm 10+** (the repository pins pnpm through Corepack)
- **Java** compatible with the current Android toolchain
...
- Create feature branches off the latest `master`.
...
- **Plugins & sources**: Improve existing plugins or propose new ones in the [`lnreader-plugins`](https://github.com/LNReader/lnreader-plugins) repository.
